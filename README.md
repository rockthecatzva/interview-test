...
1. Obtain the list of locations and building type categories from [front-end-interview-test-api](https://github.com/jpstone/interview-test-api) using the included `API.js` in **_this_** project
